...
@WebServlet(name = "frontControllerV2Servlet", urlPatterns = "/front-controller/v2/*")
public class FrontControllerV2Servlet extends HttpServlet {

    private final Map<String, ControllerV2> controllers = new HashMap<>();


    public FrontControllerV2Servlet() {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        ControllerV2 controller = controllers.get(request.getRequestURI());
